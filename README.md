...
cp .env.example .env
# Optional: open .env and replace TMDB_API_KEY with a real key from https://www.themoviedb.org/settings/api
# Without a real key, poster thumbnails will be absent but search works fine.
